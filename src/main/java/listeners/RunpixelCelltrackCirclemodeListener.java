...
public class RunpixelCelltrackCirclemodeListener implements ItemListener {
	...
	public void itemStateChanged(final ItemEvent arg0) {
		...
		if (arg0.getStateChange() == ItemEvent.DESELECTED) {
			...
			parent.Angleselect.add(parent.indistText, new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0,
					GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, parent.insets, 0, 0));

			parent.Angleselect.add(parent.interiorfield, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0,
					GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, parent.insets, 0, 0));
