...
public class InteractiveIlastikEllipseFit {
	...
	public static void main(String[] args) {
		...
		ImagePlus impB = new Opener().openImage("/Users/aimachine/Documents/TalkCurie/SmallBoundaryProbability.tif");
		impB.show();
		
		ImagePlus impC = new Opener().openImage("/Users/aimachine/Documents/TalkCurie/SmallMulticutSegmentation.tif");
		impC.show();
		
		ImagePlus impA = new Opener().openImage("/Users/aimachine/Documents/TalkCurie/SmallRawData.tif");
		impA.show();
