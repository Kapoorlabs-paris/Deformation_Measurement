...
import ij.ImagePlus;
import ij.io.Opener;
import listeners.CurrentMovieListener;
import listeners.UploadMovieListener;
...
public class EllipseFileChooser extends JPanel {
	...
	public String choosertitleB;
	  public JFrame Cardframe = new JFrame("Welcome to Ellipsoid detector");
	...
	public EllipseFileChooser() {
		...
		Measureserial.addActionListener(new UploadMovieListener(this));
		Current.addActionListener(new CurrentMovieListener(this));
	...
	public void Done(Frame parent){
		...
		new InteractiveEllipseFit(image, chooserA.getSelectedFile()).run(null);
		close(parent);
