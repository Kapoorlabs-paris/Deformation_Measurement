...
public class RectoffsetListener implements AdjustmentListener {
	...
	public RectoffsetListener(final RimSelectionListener parent, final Label label, final String string, final float min, float max,
		...
		deltaScrollbar.addMouseListener( new RecMouseListener( parent ) );
