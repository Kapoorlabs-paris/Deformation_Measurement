...
public class CurvatureFinderDistance<T extends RealType<T> & NativeType<T>> implements CurvatureFinders<T> {
	...
	public CurvatureFinderDistance(final InteractiveSimpleEllipseFit parent, final List<RealLocalizable> Ordered,final RealLocalizable centerpoint,final RandomAccessibleInterval<FloatType> ActualRoiimg,
